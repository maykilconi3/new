        ...
        <div class="card card-bg">
          <div class="card-body">
            ...
            <ul class="kural">
              ...
              <li class="kural">Başka birinin ucuza hesabı sattığı üyelikler, fark edilirse kalıcı şekilde ban yiyecektir.
              </li>
              <li class="kural">Kuralları kabul ettiysen artık sende bizden birisin! <br>
                Sorun bizdense iade alabilirsiniz. <br>
...
<div class="content py-3">
  <div class="row fs-sm">
    <div class="col-sm-6 order-sm-2 py-1 text-center text-sm-end">
      Crafted with <i class="fa fa-heart text-danger"></i> by <a class="fw-semibold" href="" target="_blank">SWANTEX 0,1</a>
    </div>
    <div class="col-sm-6 order-sm-1 py-1 text-center text-sm-start">
      <a class="fw-semibold" href="" target="_blank">JİLET 0.1</a> © <span data-toggle="year-copy" class="js-year-copy-enabled">2020 - 2023</span>
    </div>
  </div>
</div>
